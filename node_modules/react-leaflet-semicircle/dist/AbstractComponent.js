...
var AbstractComponent = /*#__PURE__*/function (_Path) {
  _inherits(AbstractComponent, _Path);

  var _super = _createSuper(AbstractComponent);
  ...
  _createClass(AbstractComponent, [{
    ...
    value: function updateLeafletElement(fromProps, _ref2) {
      ...
      if (!fromProps.position.every(function (v, i) {
